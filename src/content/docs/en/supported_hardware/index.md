...
SenseCraft HMI supports a growing range of ePaper display devices. Below is the full compatibility overview, organized by product series.
...
#### Introduction
The reTerminal E1001 features a **7.5-inch 800×480 ePaper display** with **4-level grayscale**. It offers crisp, highly legible visuals and minimal power consumption, making it ideal for battery-prioritized applications.
...
#### Introduction
The reTerminal E1003 is a **10.3-inch (1404×1872) 16-level grayscale ePaper display** powered by an **ESP32-S3**. It natively supports **SenseCraft HMI (no-code)**—with touch interaction enabled in v1.1.2—while remaining compatible with Arduino and PlatformIO. Future updates will include open-source touch libraries and ESPHome driver support.
...
#### Introduction
The reTerminal E1004 features a **13.3-inch full-color ePaper display** powered by an **ESP32-S3**. It supports **SenseCraft HMI** for no-code dashboarding and image uploads, with full compatibility for **Home Assistant**, Arduino, and ESP-IDF development.
