...
- **If you already have an account**, sign in using your existing SenseCraft, SenseCAP, Google, or GitHub account.
...
- **If you do not have an account yet**, click **Sign up** to create one. Enter your email address, verification code, username, and password, then click the sign-up button to complete registration.
