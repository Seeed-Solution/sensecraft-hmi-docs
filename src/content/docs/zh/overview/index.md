...
- **实时数据集成**：可连接天气、股票、SenseCAP 传感器、Google Calendar、RSS 等多种数据源
- **AI 驱动生成**：用自然语言描述需求，AI 即可生成图像或布局
...
| 部分 | 说明 |
| :--- | :--- |
| **[概览](/zh/overview/)** | 平台简介、功能特性、价格、注册方式以及快速开始入口。 |
| **[支持的硬件](/zh/supported_hardware/)** | 完整的兼容设备列表，包含购买链接以及精选展示/案例的快捷入口。 |
| **[指南](/zh/guides/getting_started/)** | 覆盖快速开始、设备管理、固件刷写、画布设计器和 AI 生成功能的完整教程。 |
| **[发布说明](/zh/release-notes/)** | 版本历史、最新更新和变更日志。 |
